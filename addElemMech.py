...
if jtype == 1:
    ...
    newElemStr  = '*User Element,Type=U1,Nodes=4,Coordinates=3,Properties=2,Iproperties=2\n'\
                  '1,2,3\n'\
                  '*Element, type=U1'
elif jtype == 2:
    oldElemStr  = '*Element, type=C3D10'
    newElemStr  = '*User Element,Type=U2,Nodes=10,Coordinates=3,Properties=2,Iproperties=2\n'\
                  '1,2,3\n'\
                  '*Element, type=U2'
elif jtype == 3:
    oldElemStr  = '*Element, type=C3D8'
    newElemStr  = '*User Element,Type=U3,Nodes=8,Coordinates=3,Properties=2,Iproperties=2\n'\
                  '1,2,3\n'\
                  '*Element, type=U3'
elif jtype == 4:
    ...
    newElemStr  = '*User Element,Type=U5,Nodes=3,Coordinates=2,Properties=2,Iproperties=2\n'\
                  '1,2\n'\
                  '*Element, type=U5'
elif jtype == 6:
    ...
    newElemStr  = '*User Element,Type=U7,Nodes=4,Coordinates=2,Properties=2,Iproperties=2\n'\
                  '1,2\n'\
                  '*Element, type=U7'
elif jtype == 8:
